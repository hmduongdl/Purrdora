...
export function GameStatusWidget() {
  ...
  return (
    <WidgetFactory title="GAME STATUS">
      <div className="flex flex-col gap-[clamp(6px,0.8vh,8px)] text-[clamp(11.5px,1.2vh,12.5px)]">
        ...
        <div className={`flex items-center justify-between rounded border p-[clamp(6px,0.8vh,10px)] ${
          ...
          <div className="flex items-center gap-2 text-on-surface-variant">
            <Gamepad2 size={14} className={runningGame ? "text-emerald-400" : "text-slate-600"} />
        ...
        <div className="grid grid-cols-2 gap-[clamp(6px,0.8vh,8px)] pt-[clamp(2px,0.4vh,4px)]">
          <button className="rounded border border-primary/20 bg-primary/10 py-[clamp(6px,0.8vh,8px)] text-[clamp(10.5px,1.2vh,11.5px)] font-bold uppercase tracking-wider text-primary hover:bg-primary/20 transition-colors">
            BẬT MIC
          </button>
          <button className="rounded border border-white/10 bg-white/5 py-[clamp(6px,0.8vh,8px)] text-[clamp(10.5px,1.2vh,11.5px)] font-bold uppercase tracking-wider text-slate-400 hover:border-white/20 transition-colors">
            MUTE
          </button>
        </div>
      </div>
